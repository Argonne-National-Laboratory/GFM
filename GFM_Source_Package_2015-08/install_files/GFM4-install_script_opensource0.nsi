...
!define PRODUCT_WEB_SITE "http://www.anl.gov/techtransfer/Software_Shop/GFMSoftware/GFM_Software.html"
!define PRODUCT_EXE "GFM.exe"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\${PRODUCT_EXE}"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "NSIS:StartMenuDir"
;!define BUILD_DIR "D:\ANL\GFM\Install\gfm_2e"
;!define BUILD_DIR "G:\_GFM_build\GFM_09-27-06"
;!define BUILD_DIR "C:\_GFM\_GFM_build-4\GFM_11-29-07"
;!define BUILD_DIR "I:\Argonne\_GFM_build\GFM_Release-05-15-08"
;!define BUILD_DIR "H:\Lottes\_GFM-build\GFM_Release-01-20-10"
!define BUILD_DIR "C:\Argonne\GFM_Release-02-26-14"

; Serial Numbers - can be set for each company client and compiled into the VB executible

!define SERIAL_TRIAL_VERSION_0 "test"
!define SERIAL_TRIAL_VERSION_1 "WD5HF-VHKFR-CKB6N-Q4JSP-KDN8G"
!define SERIAL_TRIAL_VERSION_2 "FK3KD-J2MFR-KTW7D-GS5RN-QHZ8C" ;John Chumley & Jim Shell
!define SERIAL_PAID_VERSION_0  "5"
!define SERIAL_PAID_VERSION_1  "GY3QZ-4FYJH-QL6DP-RV8SM-DKJ2N"

; The serial number to be checked against the value entered by the user during installation
; This serial number is written to the registry under the product information in HKLM
; Change to one of the defined values above or create a new serial number
;!define SERIAL_TO_INSTALL "${SERIAL_PAID_VERSION_1}"
!define SERIAL_TO_INSTALL "${SERIAL_TRIAL_VERSION_1}"
;--------------------------------------------
; General settings
...
; Copyright page (constructed by modifying a license page)

!define MUI_PAGE_HEADER_TEXT "Copyright Notice"
!define MUI_PAGE_HEADER_SUBTEXT \
        "Please review the copyright notice before installing ${PRODUCT_NAME} ${PRODUCT_VERSION}"
!define MUI_LICENSEPAGE_TEXT_TOP ""; "Copyright Notice"
!define MUI_LICENSEPAGE_TEXT_BOTTOM "Click OK to Continue"
;!define MUI_LICENSEPAGE_TEXT_BOTTOM "You must acknowledge the copyright notice"
!define MUI_LICENSEPAGE_BUTTON "OK"
;!define MUI_LICENSEPAGE_BUTTON "Acknowlege"
!insertmacro MUI_PAGE_LICENSE "${BUILD_DIR}\documents-source\Legal\GFM4_Copyright.rtf"
...
Section "GFM Application" SecGFM
  ...
  File "${BUILD_DIR}\documents-source\Legal\GFM4_Copyright.pdf"
  File "${BUILD_DIR}\documents-source\Legal\GFM_Trial_License.pdf"
...
Section -Post
  ...
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "ProdNum" "${SERIAL_TO_INSTALL}"
SectionEnd
...
Section Uninstall
  ...
  ;Delete "$INSTDIR\documents\GFM4_Copyright.pdf"
  ;Delete "$INSTDIR\documents\GFM4_License.pdf"
