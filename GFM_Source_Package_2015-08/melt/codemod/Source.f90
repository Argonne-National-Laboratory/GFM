...
!----------------------------------------------------------------------
         ...
         if (nps_c > 0 .and. pc0mr_Lg(id2,jd2,kd2) > zero) then 
            bs(i,j,k) = bs(i,j,k) + pc0mr_Lg(id2,jd2,kd2)*Lg(i,j,k)%c*Tmltr !need h_Tm *****************
            !bs(i,j,k) = bs(i,j,k) + pc0mr_Lg(id2,jd2,kd2)*h_Tm
         endif

         if (nps_s > 0 .and. ps0mr_Lg(id2,jd2,kd2) > zero) then 
            bs(i,j,k) = bs(i,j,k) + ps0mr_Lg(id2,jd2,kd2)*Lg(i,j,k)%c*Tmltr !need h_Tm *****************
            !bs(i,j,k) = bs(i,j,k) + ps0mr_Lg(id2,jd2,kd2)*h_Tm
         endif
         !endif
