...
if (avg_wall_T < 800.0d0) avg_wall_T = 1500.0d0         ! @@@
...
if(isum>0)  write (nu_sum,"('# ',T5,'Estimated wall loss at T_exit:',T36,E25.14,' W')") q_wall_loss_tot
...
if (avg_wall_T_r < 800.0d0) avg_wall_T_r = 1500.0d0         ! @@@
